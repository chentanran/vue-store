	...
	<view @click="open">
		...
		<view v-if="item.mode === 'base'" class="listcard">
			<view class="listcard-image">
				<image :src="item.cover && item.cover[0]" mode="aspectFill"></image>
			</view>
			<view class="listcard-content">
				...
				<view class="listcard-content__des">
					...
					<view class="listcard-content__des-browse">{{ item.collection_count }}浏览</view>
				</view>
			</view>
		</view>
		...
		<view v-if="item.mode === 'column'" class="listcard mode-column">
			<view class="listcard-content">
				...
				<view class="listcard-image">
					<view v-if="index < 3" v-for="(items,index) in item.cover" :key="index" class="listcard-image__item">
			...
			.listcard-content__des {
				...
				.listcard-content__des-label {
					...
					.listcard-content__des-label-item {
						...
						border-radius: 15px;
						color: $tz-base-color;
						border: 1px $tz-base-color solid;
					}
				}
